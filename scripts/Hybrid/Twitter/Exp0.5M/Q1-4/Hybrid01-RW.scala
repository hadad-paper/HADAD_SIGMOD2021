...
constructSparseMatirx (538000,1000,results2,"N.mtx");val sqlContext = new org.apache.spark.sql.SQLContext(sc)
...
val outputPath = "Exp0.5M/Q1-4/results-RW.out"
...
val dmlTextQuery =
  s"""
    ...
    |  VV1 = read("Exp0.5M/Q1-4/VV1.csv", format="csv", header=FALSE, sep=","); 
    |  N  = readMM("N.mtx");
