...
taskset -c 0-23 python2.7 P1.1-Q.py  $syn1  $syn2
taskset -c 0-23 python2.7 P1.1-RW.py $syn1  $syn2
	
taskset -c 0-23 python2.7 P1.2-Q.py  $syn3  $syn3
taskset -c 0-23 python2.7 P1.2-RW.py $syn3  $syn3

taskset -c 0-23 python2.7 P1.2-Q.py  $syn4  $syn4
taskset -c 0-23 python2.7 P1.2-RW.py $syn4  $syn4

taskset -c 0-23 python2.7 P1.3-Q.py  $syn5  $syn5
taskset -c 0-23 python2.7 P1.3-RW.py $syn5  $syn5

taskset -c 0-23 python2.7 P1.4-Q.py  $syn3  $syn3  $syn7
taskset -c 0-23 python2.7 P1.4-RW.py $syn3  $syn3  $syn7

taskset -c 0-23 python2.7 P1.4-Q.py  $syn4  $syn4  $syn7
taskset -c 0-23 python2.7 P1.4-RW.py $syn4  $syn4  $syn7

taskset -c 0-23 python2.7 P1.5-Q.py  $syn5  $syn5
taskset -c 0-23 python2.7 P1.5-RW.py $syn5  $syn5

taskset -c 0-23 python2.7 P1.6-Q.py  $syn5  $syn5
taskset -c 0-23 python2.7 P1.6-RW.py $syn5  $syn5

taskset -c 0-23 python2.7 P1.6-Q.py  $syn6  $syn6
taskset -c 0-23 python2.7 P1.6-RW.py $syn6  $syn6

taskset -c 0-23 python2.7 P1.7-Q.py  $syn3
taskset -c 0-23 python2.7 P1.7-RW.py $syn3

taskset -c 0-23 python2.7 P1.7-Q.py  $syn4
taskset -c 0-23 python2.7 P1.7-RW.py $syn4
	
taskset -c 0-23 python2.7 P1.8-Q.py  $syn3  $syn3
taskset -c 0-23 python2.7 P1.8-RW.py $syn3  $syn3

taskset -c 0-23 python2.7 P1.8-Q.py  $syn4  $syn4
taskset -c 0-23 python2.7 P1.8-RW.py $syn4  $syn4

taskset -c 0-23 python2.7 P1.9-Q.py  $syn5
taskset -c 0-23 python2.7 P1.9-RW.py $syn5

taskset -c 0-23 python2.7 P1.10-Q.py  $syn3
taskset -c 0-23 python2.7 P1.10-RW.py $syn3

taskset -c 0-23 python2.7 P1.10-Q.py  $syn4
taskset -c 0-23 python2.7 P1.10-RW.py $syn4

taskset -c 0-23 python2.7 P1.11-Q.py  $syn3  $syn3
taskset -c 0-23 python2.7 P1.11-RW.py $syn3  $syn3

taskset -c 0-23 python2.7 P1.11-Q.py  $syn4  $syn4
taskset -c 0-23 python2.7 P1.11-RW.py $syn4  $syn4

taskset -c 0-23 python2.7 P1.12-Q.py  $syn1  $syn2
taskset -c 0-23 python2.7 P1.12-RW.py $syn1  $syn2

taskset -c 0-23 python2.7 P1.13-Q.py  $syn1  $syn2
taskset -c 0-23 python2.7 P1.13-RW.py $syn1  $syn2

taskset -c 0-23 python2.7 P1.14-Q.py  $syn1  $syn2
taskset -c 0-23 python2.7 P1.14-RW.py $syn1  $syn2

taskset -c 0-23 python2.7 P1.15-Q.py  $syn1  $syn2
taskset -c 0-23 python2.7 P1.15-RW.py $syn1  $syn2

taskset -c 0-23 python2.7 P1.16-Q.py  $syn3
taskset -c 0-23 python2.7 P1.16-RW.py $syn3

taskset -c 0-23 python2.7 P1.16-Q.py  $syn4
taskset -c 0-23 python2.7 P1.16-RW.py $syn4

taskset -c 0-23 python2.7 P1.17-Q.py  $syn5  $syn5
taskset -c 0-23 python2.7 P1.17-RW.py $syn5  $syn5

taskset -c 0-23 python2.7 P1.18-Q.py  $syn3
taskset -c 0-23 python2.7 P1.18-RW.py $syn3

taskset -c 0-23 python2.7 P1.18-Q.py  $syn4
taskset -c 0-23 python2.7 P1.18-RW.py $syn4
...
taskset -c 0-23 python2.7 P1.23-Q.py  $syn5 $syn5
