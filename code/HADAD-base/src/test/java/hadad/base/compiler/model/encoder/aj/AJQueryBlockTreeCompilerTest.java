...
/**
 * AJ NestedBlockTreeCompilerTest
 * 
 *   
 *
 */
public abstract class AJQueryBlockTreeCompilerTest extends AbstractQueryBlockTreeCompilerTest {
    private static final String TESTS_DIR = "/compiler/aj-encoder";
    private static final Logger LOGGER = Logger.getLogger(AJQueryBlockTreeCompilerTest.class);
    ...
    private List<File> getTestsDirectories() {
        final File directory =
                new File(AJQueryBlockTreeCompilerTest.class.getResource(TESTS_DIR).toString().substring(5));
