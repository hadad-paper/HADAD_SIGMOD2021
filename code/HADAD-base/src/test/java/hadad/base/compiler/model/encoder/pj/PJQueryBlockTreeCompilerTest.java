 ...
 *
 */
public abstract class PJQueryBlockTreeCompilerTest extends AbstractQueryBlockTreeCompilerTest {
    private static final String TESTS_DIR = "/compiler/pj-encoder";
    private static final Logger LOGGER = Logger.getLogger(PJQueryBlockTreeCompilerTest.class);
    ...
    private List<File> getTestsDirectories() {
        final File directory =
                new File(PJQueryBlockTreeCompilerTest.class.getResource(TESTS_DIR).toString().substring(5));
