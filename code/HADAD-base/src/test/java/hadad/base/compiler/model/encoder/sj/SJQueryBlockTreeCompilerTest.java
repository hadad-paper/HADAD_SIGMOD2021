...
/**
 * SJ NestedBlockTreeCompilerTest
 * 
 *   
 *
 */
public abstract class SJQueryBlockTreeCompilerTest extends AbstractQueryBlockTreeCompilerTest {
    private static final String TESTS_DIR = "/compiler/sj-encoder";
    private static final Logger LOGGER = Logger.getLogger(SJQueryBlockTreeCompilerTest.class);
    ...
    private List<File> getTestsDirectories() {
        final File directory =
                new File(SJQueryBlockTreeCompilerTest.class.getResource(TESTS_DIR).toString().substring(5));
