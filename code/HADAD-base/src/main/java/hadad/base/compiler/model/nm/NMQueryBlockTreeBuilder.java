...
/**
 * NM QueryBlockTreeBuilder which implements {@link QueryBlockTreeBuilder}.
 */
@Singleton
public final class NMQueryBlockTreeBuilder implements QueryBlockTreeBuilder {
    ...
    @Inject
    public NMQueryBlockTreeBuilder(final PathExpressionListener pathExpressionListener,
