...
/**
 * RM Return template constructor
 * 
 *  
 */
public class RMReturnTemplateConstructor implements ReturnTemplateConstructor {
    private final RMConstructReturnTermVisitor constructVisitor;

    public RMReturnTemplateConstructor() {
        constructVisitor = new RMConstructReturnTermVisitor();
    }
    ...
    private class RMConstructReturnTermVisitor implements ReturnTemplateVisitor {
