 ...
 *  
 */
public abstract class SMModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("DMLVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(SMQueryBlockTreeBuilder.class);
    }
