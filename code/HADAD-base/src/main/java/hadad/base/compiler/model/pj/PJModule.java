...
/**
 * PJModule which extends {@link AbstractModule}
 *
 */
public abstract class PJModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("PJQLVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(PJQueryBlockTreeBuilder.class);
    }
