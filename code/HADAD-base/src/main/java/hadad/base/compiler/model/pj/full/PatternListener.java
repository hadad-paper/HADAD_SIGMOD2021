...
final class PatternListener {
    ...
    public Pattern parse(final String str) throws ParseException {
        ...
        final ParserRuleContext tree = parser.pjFromWhereClause();
     ...
     */
    private class PatternListenerAux extends PJQLBaseListener {
        ...
        @Override
        public void enterPjFromClause(PJQLParser.PjFromClauseContext ctx) {
