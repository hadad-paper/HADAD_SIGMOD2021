...
/**
 * PJ QueryBlockTreeBuilder which implements {@link QueryBlockTreeBuilder }.
 *
 */
@Singleton
public final class PJFULLQueryBlockTreeBuilder implements QueryBlockTreeBuilder {
    ...
    @Inject
    public PJFULLQueryBlockTreeBuilder(final PathExpressionListener pathExpressionListener,
