 ...
 *  
 */
public abstract class TMModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("TFMVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(TMQueryBlockTreeBuilder.class);
    }
