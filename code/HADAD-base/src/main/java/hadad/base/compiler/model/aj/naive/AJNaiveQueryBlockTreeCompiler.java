...
public final class AJNaiveQueryBlockTreeCompiler implements QueryBlockTreeViewCompiler {
    ...
    private final AJForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor;
    private final AJBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor;
    private final AJDocumentNamesExtractor aJDocumentNamesExtractor;

    @Inject
    public AJNaiveQueryBlockTreeCompiler(@Named("document_name_prefix") final String documentNamePrefix,
            ...
            final AJForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor,
            final AJBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor,
