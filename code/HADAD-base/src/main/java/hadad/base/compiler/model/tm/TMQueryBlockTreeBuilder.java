 ...
 */
@Singleton
public final class TMQueryBlockTreeBuilder implements QueryBlockTreeBuilder {
    ...
    @Inject
    public TMQueryBlockTreeBuilder(final PathExpressionListener pathExpressionListener,
