 ...
 * 
 */
public final class XQNaiveNestedBlockTreeCompiler implements QueryBlockTreeViewCompiler {
    ...
    private final XQForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor;
    private final XQBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor;
    private final XQDocumentNamesExtractor xQDocumentNamesExtractor;

    @Inject
    public XQNaiveNestedBlockTreeCompiler(@Named("document_name_prefix") final String documentNamePrefix,
            ...
            final XQForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor,
            final XQBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor,
