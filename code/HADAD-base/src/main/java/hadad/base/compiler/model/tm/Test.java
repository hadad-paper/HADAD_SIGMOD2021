...
public class Test {
	...
	private static final int ESTIM =0;
	...
	public static void main(String[] args) throws Exception {
		...
		for (File file : getTestsDirectories()) {	
			...
			//TODO:Temp skip		
			if(file.getName().equals("P2.20")||file.getName().equals("P2.14")||file.getName().equals("P2.25")||file.getName().equals("P2.27")||file.getName().equals("P2.21")) {
				continue;
			}
