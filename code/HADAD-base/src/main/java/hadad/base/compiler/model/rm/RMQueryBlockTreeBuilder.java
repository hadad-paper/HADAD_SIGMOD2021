...
/**
 * RM QueryBlockTreeBuilder which implements {@link QueryBlockTreeBuilder}.
 * 
 *   
 */
@Singleton
public final class RMQueryBlockTreeBuilder implements QueryBlockTreeBuilder {
    ...
    @Inject
    public RMQueryBlockTreeBuilder(final PathExpressionListener pathExpressionListener,
