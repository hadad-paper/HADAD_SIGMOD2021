...
/**
 * AJ return remplate constructor which implements {@link ReturnTemplateConstructor}
 * 
 *   
 *   
 */
public class AJReturnTemplateConstructor implements ReturnTemplateConstructor {
    private final XQConstructReturnTermVisitor constructVisitor;

    public AJReturnTemplateConstructor() {
