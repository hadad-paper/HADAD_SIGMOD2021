 ...
 *
 */
public abstract class SPPJModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("SPPJQLVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(SPPJQueryBlockTreeBuilder.class);
    }
