...
/**
 * AJ extractor variable to node visitor {@link ReturnTemplateVisitor}
 *
 */
@Singleton
public class AJExtractVariableToCreatedNodeVisitor implements ReturnTemplateVisitor {
    ...
    @Inject
    public AJExtractVariableToCreatedNodeVisitor(final VariableCopier variableCopier) {
