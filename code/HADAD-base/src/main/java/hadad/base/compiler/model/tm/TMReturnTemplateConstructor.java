...
/**
 * TM Return template constructor
 * 
 *  
 */
public class TMReturnTemplateConstructor implements ReturnTemplateConstructor {
    private final TMConstructReturnTermVisitor constructVisitor;

    public TMReturnTemplateConstructor() {
        constructVisitor = new TMConstructReturnTermVisitor();
    }
    ...
    private class TMConstructReturnTermVisitor implements ReturnTemplateVisitor {
