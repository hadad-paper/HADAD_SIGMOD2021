...
@Singleton
class AJBackwardEncoderNestedBlockTreeVisitor implements QueryBlockTreeVisitor {
	private final AJExtractVariableToCreatedNodeVisitor aJExtractVariableToCreatedNodeVisitor;
	private final AJBlockBackwardEncoderReturnTermVisitor aJBlockBackwardEncoderReturnTermVisitor;
	...
	@Inject
	public AJBackwardEncoderNestedBlockTreeVisitor(
			...
			final AJBlockBackwardEncoderReturnTermVisitor aJBlockBackwardEncoderReturnTermVisitor) {
		this.aJExtractVariableToCreatedNodeVisitor = aJExtractVariableToCreatedNodeVisitor;
		this.aJBlockBackwardEncoderReturnTermVisitor = aJBlockBackwardEncoderReturnTermVisitor;
	...
	private List<Constraint> getConstraintConnectingCreateToJSONConstructedByView(
		...
		final List<List<Atom>> premises = aJBlockBackwardEncoderReturnTermVisitor
