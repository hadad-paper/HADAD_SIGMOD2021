...
@Singleton
public final class SPPJBlockBackwardEncoderReturnTermVisitor implements ReturnTemplateVisitor {
    ...
    @Inject
    public SPPJBlockBackwardEncoderReturnTermVisitor(final ArrayElementFactory arrayElementFactory,
