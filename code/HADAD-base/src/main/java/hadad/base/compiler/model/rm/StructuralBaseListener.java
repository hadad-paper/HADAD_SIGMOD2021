...
/**
 * R StructuralBaseListener
 * 
 *   
 *
 */
abstract class StructuralBaseListener extends RBaseListener {
    ...
    protected abstract ParserRuleContext createParseTree(final RParser parser);
}
