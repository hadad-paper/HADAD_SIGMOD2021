...
final class PatternListener {
    ...
    public Pattern parse(final String str) throws ParseException {
        ...
        final ParserRuleContext tree = parser.flwrForWhere();
     ...
     */
    private class PatternListenerAux extends XQueryBaseListener {
        ...
        @Override
        public void enterFlwrFor(XQueryParser.FlwrForContext ctx) {
        ...
        @Override
        public void enterFlwrWhere(XQueryParser.FlwrWhereContext ctx) {
            if (structural != null && conditional == null) {
