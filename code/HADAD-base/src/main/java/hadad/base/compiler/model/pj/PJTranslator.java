...
/**
 * Translate the rewriting to PJQL query
 *
 */
public class PJTranslator {
    ...
    private static final String JSON_ARRAYS_ELEMENTS = " JSON_ARRAYS_ELEMENTS ";
    ...
    public PJTranslator(final ConjunctiveQuery query) {
        this.query = query;
    }
