 ...
 *   
 */
public final class PJFullNaiveQueryBlockTreeCompiler implements QueryBlockTreeViewCompiler {
    ...
    private final PJFullForwardEncoderQueryBlockTreeVisitor forwardEncoderVisitor;
    private final PJFullBackwardEncoderQueryBlockTreeVisitor backwardEncoderVisitor;
    private final PJDocumentNamesExtractor pJDocumentNamesExtractor;
    private Variable viewID;

    @Inject
    public PJFullNaiveQueryBlockTreeCompiler(@Named("document_name_prefix") final String documentNamePrefix,
            ...
            final PJFullForwardEncoderQueryBlockTreeVisitor forwardEncoderVisitor,
            final PJFullBackwardEncoderQueryBlockTreeVisitor backwardEncoderVisitor,
