 ...
 * NM Module
 */
public abstract class NMModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("NMVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(NMQueryBlockTreeBuilder.class);
    }
