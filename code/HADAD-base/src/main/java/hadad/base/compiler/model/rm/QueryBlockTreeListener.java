...
final class QueryBlockTreeListener {
    ...
    public QueryBlockTreeListener(final BlockListener blockListener,
            ...
            @Named("RVariableFactory") final VariableFactory aqlVariableFactory, final VariableMapper variableMapper) {
    ...
    public QueryBlockTree parse(final String str) throws ParseException {
        ...
        final ParserRuleContext tree = parser.rQuery();
        ...
        if (listener.hasRootElement()) {
            ...
            terms.add(parent);
            root = new RootBlock(listener.getQueryName(), new ReturnTemplate(RMModel.ID, terms));
    ...
    private class NestedBlockTreeListenerAux extends RBaseListener {
        ...
        @Override
        public void enterRQuery(RParser.RQueryContext ctx) {
            LOGGER.debug("Entering RQuery: " + ctx.getText());
        ...
        @Override
        public void enterViewName(RParser.ViewNameContext ctx) {
        ...
        public void enterRScript(RParser.RScriptContext ctx) {
            //LOGGER.debug("Entering RScript: " + ctx.getText());
        ...
        @Override
        public void exitRScript(RParser.RScriptContext ctx) {
