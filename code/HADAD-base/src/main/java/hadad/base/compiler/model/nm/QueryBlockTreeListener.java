...
final class QueryBlockTreeListener {
    ...
    public QueryBlockTreeListener(final BlockListener blockListener,
            ...
            @Named("NMVariableFactory") final VariableFactory aqlVariableFactory, final VariableMapper variableMapper) {
    ...
    public QueryBlockTree parse(final String str) throws ParseException {
        ...
        final ParserRuleContext tree = parser.numPyQuery();
        ...
        if (listener.hasRootElement()) {
            ...
            terms.add(parent);
            root = new RootBlock(listener.getQueryName(), new ReturnTemplate(NMModel.ID, terms));
    ...
    private class NestedBlockTreeListenerAux extends NumPyBaseListener {
        ...
        @Override
        public void enterNumPyQuery(NumPyParser.NumPyQueryContext ctx) {
            //LOGGER.debug("Entering NumPyQuery: " + ctx.getText());
        ...
        @Override
        public void enterViewName(NumPyParser.ViewNameContext ctx) {
        ...
        public void enterNumPyScript(NumPyParser.NumPyScriptContext ctx) {
            //LOGGER.debug("Entering NumPyScript: " + ctx.getText());
        ...
        @Override
        public void exitNumPyScript(NumPyParser.NumPyScriptContext ctx) {
