...
import hadad.base.compiler.model.pj.PJDocumentNamesExtractor;
import hadad.base.compiler.model.pj.Predicate;
import hadad.base.compiler.model.pj.Utils;

/**
 * PJ NaiveQueryBlockTreeCompiler
 * 
 *   
 */
public final class PJNaiveQueryBlockTreeCompiler implements QueryBlockTreeViewCompiler {
    ...
    private final PJForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor;
    private final PJBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor;
    private final PJDocumentNamesExtractor pJDocumentNamesExtractor;

    @Inject
    public PJNaiveQueryBlockTreeCompiler(@Named("document_name_prefix") final String documentNamePrefix,
            ...
            final PJForwardEncoderNestedBlockTreeVisitor forwardEncoderVisitor,
            final PJBackwardEncoderNestedBlockTreeVisitor backwardEncoderVisitor,
            final PJDocumentNamesExtractor pJDocumentNamesExtractor) {
        ...
        this.pJDocumentNamesExtractor = pJDocumentNamesExtractor;
    }

    @Override
    public List<? extends Constraint> compileForwardConstraints(final QueryBlockTree nbt, boolean includeComments)
            throws CompilationException {
        final Set<String> documentNames = pJDocumentNamesExtractor.getDocumentNames(nbt);
