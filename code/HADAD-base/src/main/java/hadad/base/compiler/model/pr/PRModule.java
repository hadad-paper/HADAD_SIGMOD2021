...
public abstract class PRModule extends AbstractModule {
	@Override
	protected void configure() {
		...
		bind(VariableFactory.class).annotatedWith(Names.named("ConjunctiveQueryVariableFactory")).toInstance(
		        new VariableFactory(properties.getProperty("fresh_conjunctive_query_variable_prefix", "sf_")));
		bind(VariableFactory.class).annotatedWith(Names.named("SQLVariableFactory"))
		        .toInstance(new VariableFactory(properties.getProperty("fresh_map_variable_prefix", "sg_")));
		bind(VariableFactory.class).annotatedWith(Names.named("ElementVariableFactory"))
		        .toInstance(new VariableFactory(properties.getProperty("fresh_element_variable_prefix", "sh_")));
		...
		bind(QueryBlockTreeBuilder.class).to(PRQueryBlockTreeBuilderAlternative.class);
	}
