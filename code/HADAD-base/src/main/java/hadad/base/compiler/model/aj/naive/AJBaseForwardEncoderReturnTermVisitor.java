...
abstract class AJBaseForwardEncoderReturnTermVisitor implements
	...
	@Inject
	public AJBaseForwardEncoderReturnTermVisitor(final ArrayElementFactory arrayElementFactory) {
