...
/**
 * AJ Document names extractor which implements {@link QueryBlockTreeVisitor}
 *
 */
@Singleton
public class AJDocumentNamesExtractor implements QueryBlockTreeVisitor {
    private final String documentNamePrefix;
    private Set<String> documentNames;

    @Inject
    public AJDocumentNamesExtractor(@Named("document_name_prefix") final String documentNamePrefix) {
