...
final class QueryBlockTreeListener {
    ...
    public QueryBlockTree parse(final String str) throws ParseException {
        final String preProcessedQuery = PreProcessQuery.process(str);
    ...
    private class NestedBlockTreeListenerAux extends PJQLBaseListener {
        ...
        @Override
        public void enterPjqlQuery(PJQLParser.PjqlQueryContext ctx) {
            LOGGER.debug("Entering PJQLQuery: " + ctx.getText());
        ...
        @Override
        public void enterViewName(PJQLParser.ViewNameContext ctx) {
