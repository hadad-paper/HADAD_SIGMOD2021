 ...
 */
@Singleton
public final class PJQueryBlockTreeBuilder implements QueryBlockTreeBuilder {
    ...
    @Inject
    public PJQueryBlockTreeBuilder(final PathExpressionListener pathExpressionListener,
