...
@Singleton
public final class PJBlockBackwardEncoderReturnTermVisitor implements ReturnTemplateVisitor {
	...
	@Inject
	public PJBlockBackwardEncoderReturnTermVisitor(final ArrayElementFactory arrayElementFactory,
