 ...
 *   
 */
public abstract class SJModule extends AbstractModule {
    @Override
    protected void configure() {
        ...
        bind(VariableFactory.class).annotatedWith(Names.named("SJQLVariableFactory"))
        ...
        bind(QueryBlockTreeBuilder.class).to(SJQueryBlockTreeBuilder.class);
    }
