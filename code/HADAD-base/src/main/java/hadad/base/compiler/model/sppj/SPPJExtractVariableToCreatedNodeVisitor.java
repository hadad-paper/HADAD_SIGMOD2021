...
/**
 * SPPJ ExtractVariableToCreatedNodeVisitor
 * 
 * 
 *
 */
@Singleton
public class SPPJExtractVariableToCreatedNodeVisitor implements ReturnTemplateVisitor {
    ...
    @Inject
    public SPPJExtractVariableToCreatedNodeVisitor(final VariableCopier variableCopier) {
