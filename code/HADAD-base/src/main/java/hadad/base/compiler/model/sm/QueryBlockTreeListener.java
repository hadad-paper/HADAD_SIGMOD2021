...
final class QueryBlockTreeListener {
    ...
    public QueryBlockTreeListener(final BlockListener blockListener,
            ...
            @Named("DMLVariableFactory") final VariableFactory aqlVariableFactory,
    ...
    public QueryBlockTree parse(final String str) throws ParseException {
        ...
        if (listener.hasRootElement()) {
            ...
            terms.add(parent);
            root = new RootBlock(listener.getQueryName(), new ReturnTemplate(SMModel.ID, terms));
    ...
    private class NestedBlockTreeListenerAux extends DMLBaseListener {
        ...
        @Override
        public void enterDmlQuery(DMLParser.DmlQueryContext ctx) {
        ...
        @Override
        public void enterViewName(DMLParser.ViewNameContext ctx) {
        ...
        @Override
        public void exitDmlScript(DMLParser.DmlScriptContext ctx) {
