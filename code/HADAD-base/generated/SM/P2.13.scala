...
val dmlTextQuery ="""b_0=read("syn1.csv", format="csv", header=FALSE, sep=",")
b_2=read("syn2z.csv", format="csv", header=FALSE, sep=",")
b_1=read("syn2.csv", format="csv", header=FALSE, sep=",")
RW0=((b_0%*%b_1)%*%b_0)"""
