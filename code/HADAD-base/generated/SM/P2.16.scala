...
val dmlTextQuery ="""b_2=read("syn5e.csv", format="csv", header=FALSE, sep=",")
c_3=read("V1.csv", format="csv", header=FALSE, sep=",")
c_4=read("V7.csv", format="csv", header=FALSE, sep=",")
RW11=(det((b_2+(c_3%*%c_4))))"""
