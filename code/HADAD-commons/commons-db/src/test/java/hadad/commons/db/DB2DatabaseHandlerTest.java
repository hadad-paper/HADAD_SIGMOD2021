...
public class DB2DatabaseHandlerTest extends DatabaseHandlerTest {
    ...
    public void testGetNumberOfSelectedFields() {
    	// GIVEN
    	final DatabaseHandler dbHandler = new DB2DatabaseHandler(Mockito.mock(Connection.class));
    ...
    public void testCreateStatement() throws SQLException {
    	...
    	final DatabaseHandler dbHandler = new DB2DatabaseHandler(conn);
