...
taskset -c 0-23 python2.7 P1.4-RW.py $V6A  $syn7

taskset -c 0-23 python2.7 P1.4-Q.py  $syn4  $syn4  $syn7
taskset -c 0-23 python2.7 P1.4-RW.py $V6B  $syn7
...
taskset -c 0-23 python2.7 P1.17-RW.py $V10  $syn5
...
taskset -c 0-23 python2.7 P1.23-RW.py $V1 $V7 $syn5
...
taskset -c 0-23 python2.7 P2.2-Q.py  $syn5
taskset -c 0-23 python2.7 P2.2-RW.py $V1
...
taskset -c 0-23 python2.7 P2.5-RW.py $V9
